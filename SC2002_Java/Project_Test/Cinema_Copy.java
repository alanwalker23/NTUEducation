...
public class Cinema {
    ...
    private static int[] occupiedSeats = new int[15];
    private int Cinema_ID;
    private int TotalNumOfSeat;
    private Date[] Showtime = new Date[15];
    private int Type;
    private Cinema_Seat[][] seats = new Cinema_Seat[15][];
    private Movie[] movie = new Movie[15]; // read name from csv then convert to movie object
    ...
    public Cinema(int type, Date[] showtimes) {
        ...
        if (type == 0) {
            ...
            this.seats = new Cinema_Seat[15][50];
        } else if (type == 1) {
